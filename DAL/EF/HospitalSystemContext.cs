...
namespace DAL.EF
{
    ...
    public class HospitalSystemDbInitializer : DropCreateDatabaseIfModelChanges<HospitalSystemContext>
    {
        protected override void Seed(HospitalSystemContext db)
        {
            ...
            db.Doctor.Add(new Doctor { FirstName = "Григорий", LastName = "Веселый", PhoneNumber = "+77074548521" });
            db.Doctor.Add(new Doctor { FirstName = "Светлана", LastName = "Скороходова", PhoneNumber = "+77765532561" });
            db.Doctor.Add(new Doctor { FirstName = "Роман", LastName = "Лобаненко", PhoneNumber = "+77771584976" });
            db.SaveChanges();
